...
diff_out <- function (i, j, plot = TRUE) {
    ...
    ## Save the results
    write.table(diff_OTU, paste0(analysis_dir, "/tabs/DESeq2_SIGNIF_OTUs_", i, "_vs_", j, "_log2foldchange.csv"),
...
#### Species
``` {r Section8_sen_barplot_top_species_normalised_abundance_stacked, fig.height = 8, fig.width = 8}
species_dat_sen <- plot_barplot_sen2("Species")
species_dat_sen[[1]]
```
...
diff_out_sen <- function (i, j, plot = TRUE) {
    ...
    ## Save the results
    write.table(diff_OTU, paste0(analysis_dir, "/tabs/Sensitivity_DESeq2_SIGNIF_OTUs_", i, "_vs_", j, "_log2foldchange.csv"),
                row.names = FALSE, col.names = TRUE, sep = ",", quote = FALSE)
