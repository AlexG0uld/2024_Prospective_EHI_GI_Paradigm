---
title: "16S rRNA Analysis - Moderate/Severe vs Control (manuscript)"
author: "Alex Gould"
date: "`r date()`"
output:
  pdf_document:
...
This is sub-group analyses comparing only the moderate (n=18) and severe (n=6) cases (TOTAL n=24) against matched controls. 
...
adiv_group_plot <- adiv_long %>%
  ...
  scale_fill_manual(values = group_cols) +
  scale_color_manual(values = group_cols) +
  scale_x_discrete(labels = c("Non-EHI", "Mod/Sev\nEHI")) +
  labs(
    x = "",
    y = "Alpha Diversity"
  ) +
  ...
  expand_limits(y=0) +
  stat_summary(data = filter(adiv_long, Normal), 
               fun = mean, 
               geom = "point", 
               color = "black", 
               size = 3, 
...
bdiv_group_plot <- plot_ordination(phyloseq_dat_filter, 
  ...
  ggtitle("") + 
  scale_fill_manual(values = group_cols,
                    labels = c("Control" = "Non-EHI", "EHI" = "Mod/Sev\nEHI")) +
  scale_color_manual(values = group_cols,
                     labels = c("Control" = "Non-EHI", "EHI" = "Mod/Sev\nEHI")) +
  theme_classic() +
  theme(
...
plot_abundance_comparison <- function (taxa,
  ...
  p2 <- plot_dat %>%
    ...
    scale_fill_manual(values = group_cols,
                      labels = c("EHI" = "Mod/Sev EHI", "Control" = "Non-EHI")) +
...
ggsave(
  filename = paste0(
    analysis_dir,
    "figs/GRANNUS_microbiome_modsev_control_panel",
    ".png"
  ),
...
bdiv_sen_plot <- plot_ordination(phyloseq_dat_sen_filter, 
  ...
  ggtitle("") + 
  scale_fill_manual(values = group_cols,
                    labels = c("Control" = "Control", "EHI" = "Mod/Sev\nEHI")) +
  scale_color_manual(values = group_cols,
                     labels = c("Control" = "Control", "EHI" = "Mod/Sev\nEHI")) +
  theme_classic() +
  theme(
